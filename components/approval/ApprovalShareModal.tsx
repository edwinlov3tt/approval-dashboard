    ...
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-12 text-text-muted">{tierDescription}</p>
        </div>
        <Button
          type="button"
          variant="outline"
      ...
      {participants.length === 0 ? (
        <div className="text-center py-4 text-12 text-text-muted">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              ...
              <div className="text-left">
                <div className="text-14 font-medium">Email</div>
            ...
            >
              ...
              <div className="text-left">
                <div className="text-14 font-medium">Shareable Link</div>
                <div className="text-12 text-text-muted">
